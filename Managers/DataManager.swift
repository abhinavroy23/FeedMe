        ...
        if let currentContext = context{
            ...
            do {
                ...
                if(searchResultCDList.count > 0){
                    ...
                    searchResultCD.setValue(searchResult.link, forKey: "link")
                    searchResultCD.setValue(searchResult.location, forKey: "location")
                    searchResultCD.setValue(searchResult.nearbyRestaurants, forKey: "nearbyRestaurants")
                    searchResultCD.setValue(searchResult.popularity, forKey: "popularity")
                    do{
